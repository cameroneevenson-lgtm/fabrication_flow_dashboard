...
set "LOG=%APPDIR%\fabrication_flow_dashboard_launch.log"
...
if not "%FAB_FLOW_HOT_RELOAD%"=="" set DEV_HOT_RELOAD=%FAB_FLOW_HOT_RELOAD%
if not "%FAB_FLOW_HOT_INTERVAL%"=="" set HOT_RELOAD_INTERVAL=%FAB_FLOW_HOT_INTERVAL%
if not "%FAB_FLOW_HOT_DEBOUNCE%"=="" set HOT_RELOAD_DEBOUNCE=%FAB_FLOW_HOT_DEBOUNCE%
if not "%FAB_FLOW_HOT_MIN_UPTIME%"=="" set HOT_RELOAD_MIN_UPTIME=%FAB_FLOW_HOT_MIN_UPTIME%
if not "%FAB_FLOW_HOT_DECISION_TIMEOUT%"=="" set HOT_RELOAD_DECISION_TIMEOUT=%FAB_FLOW_HOT_DECISION_TIMEOUT%
